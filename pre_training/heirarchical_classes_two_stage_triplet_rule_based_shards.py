...
from models_ import HierTwoStageTriplet
# import warnings
...
save_model_folder = 'Models_two_stage_triplet_rule_based_hier_32'
...
def make_dataset(sents1, sents2, sents3, tokenizer, max_len_input, max_num_seqs, heirarchical_encoding_sent1, heirarchical_encoding_sent2, heirarchical_encoding_sent3, label_sent1, label_sent2, label_sent3):        
  ...
  if model_type == 'roberta':
    dataset = TensorDataset(all_input_ids1, all_input_ids2, all_input_ids3, all_attention_masks1, all_attention_masks2, all_attention_masks3, sent1_all_heirarchical_encodding_1,  
    ...
    dataset = TensorDataset(all_input_ids1, all_input_ids2, all_input_ids3, all_attention_masks1, all_attention_masks2, all_attention_masks3, all_tok_type_ids_1, all_tok_type_ids_2, all_tok_type_ids_3, sent1_all_heirarchical_encodding_1,  
                            sent1_all_heirarchical_encodding_2,  sent1_all_heirarchical_encodding_3,  sent1_all_heirarchical_encodding_4,  sent1_all_heirarchical_encodding_5,  sent1_all_heirarchical_encodding_6,  sent1_all_heirarchical_encodding_7,
                            sent2_all_heirarchical_encodding_1,  sent2_all_heirarchical_encodding_2,  sent2_all_heirarchical_encodding_3,  
                            sent2_all_heirarchical_encodding_4,  sent2_all_heirarchical_encodding_5, sent2_all_heirarchical_encodding_6,  sent2_all_heirarchical_encodding_7, 
                            sent3_all_heirarchical_encodding_1,  sent3_all_heirarchical_encodding_2,  sent3_all_heirarchical_encodding_3,  
...
train_dataset = make_dataset(emanuals1, emanuals2, emanuals3, tokenizer, seq_len, max_num_seqs, heirarchical_encoding_sent1, heirarchical_encoding_sent2, heirarchical_encoding_sent3, label_sent1, label_sent2, label_sent3)
...
if model_type == 'roberta':
  model = nn.DataParallel(HierTwoStageTriplet(num_topics_each_level, model_path))  

if shard_num > 1:
  model.load_state_dict(torch.load(os.path.join(save_model_folder, 'twostagetriplet_hier_epochs_1_shard_{}.pt'.format(shard_num-1))))
...
for epoch_i in tqdm(range(EPOCHS)):
  ...
  for step, batch in enumerate(epoch_iterator):
    # model.zero_grad()
    if model_type == 'roberta':
      anchor_out, pos_out, neg_out, heirarchy_out1_emb1, heirarchy_out2_emb1, heirarchy_out3_emb1, heirarchy_out4_emb1, heirarchy_out5_emb1, heirarchy_out6_emb1, heirarchy_out7_emb1, heirarchy_out1_emb2, heirarchy_out2_emb2, heirarchy_out3_emb2, heirarchy_out4_emb2, heirarchy_out5_emb2, heirarchy_out6_emb2, heirarchy_out7_emb2, heirarchy_out1_emb3, heirarchy_out2_emb3, heirarchy_out3_emb3, heirarchy_out4_emb3, heirarchy_out5_emb3, heirarchy_out6_emb3, heirarchy_out7_emb3 = model.forward(batch[0].to(device), batch[1].to(device), batch[2].to(device), batch[3].to(device), batch[4].to(device), batch[5].to(device))
    else:
      anchor_out, pos_out, neg_out, heirarchy_out1_emb1, heirarchy_out2_emb1, heirarchy_out3_emb1, heirarchy_out4_emb1, heirarchy_out5_emb1, heirarchy_out6_emb1, heirarchy_out7_emb1, heirarchy_out1_emb2, heirarchy_out2_emb2, heirarchy_out3_emb2, heirarchy_out4_emb2, heirarchy_out5_emb2, heirarchy_out6_emb2, heirarchy_out7_emb2, heirarchy_out1_emb3, heirarchy_out2_emb3, heirarchy_out3_emb3, heirarchy_out4_emb3, heirarchy_out5_emb3, heirarchy_out6_emb3, heirarchy_out7_emb3 = model.forward(batch[0].to(device), batch[1].to(device), batch[2].to(device), batch[3].to(device), batch[4].to(device), batch[5].to(device), batch[6].to(device), batch[7].to(device), batch[8].to(device))
    ...
    if (epoch_i * len(train_dataloader) + step + 1) % 10000 == 0:
      torch.save(model.state_dict(), os.path.join(save_model_folder, 'twostagetriplet_hier_epochs_{}_{}_{}_shard_{}.pt'.format(epoch_i + 1, step + 1, BATCH_SIZE, shard_num)))
  avg_train_loss = total_train_loss / len(train_dataloader)
  loss_list.append(avg_train_loss)
  print('Loss after epoch {} = {}'.format(epoch_i + 1, avg_train_loss))
torch.save(model.state_dict(), os.path.join(save_model_folder, 'twostagetriplet_hier_epochs_{}_shard_{}.pt'.format(epoch_i + 1, shard_num)))
print(loss_list)
